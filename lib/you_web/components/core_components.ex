defmodule YouWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(YouWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(YouWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  @doc """
  Flattens a changeset's errors into one line, for flash messages.
