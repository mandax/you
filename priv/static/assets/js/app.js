...
`
  ...
  // ../_build/dev/phoenix-colocated/you/YouWeb.Components.Base.CopyButton/29_5ab4cbd474z5jc7bcq2fewz5he.js
  var ab4cbd474z5jc7bcq2fewz5he_default = {
    mounted() {
  ...
  // ../_build/dev/phoenix-colocated/you/YouWeb.Components.Base.Dialog/50_dzgjiq32nc4xvceuoruijkndii.js
  var dzgjiq32nc4xvceuoruijkndii_default = {
    mounted() {
  ...
  // ../_build/dev/phoenix-colocated/you/YouWeb.Components.Base.DropdownMenu/49_cxchekpzupmkes33am6nazq5va.js
  var cxchekpzupmkes33am6nazq5va_default = {
    mounted() {
      this.trigger = this.el.querySelector('[data-part="trigger"]');
      this.popup = this.el.querySelector('[data-part="popup"]');
      this.index = -1;
      this.items = () => Array.from(this.popup.querySelectorAll('[role="menuitem"]:not([data-disabled])'));
      this.highlight = (i) => {
  ...
  // ../_build/dev/phoenix-colocated/you/YouWeb.Components.Base.Tooltip/39_qsspfro4d5z2i5houqtw2dkbs4.js
  var qsspfro4d5z2i5houqtw2dkbs4_default = {
    mounted() {
      this.trigger = this.el.querySelector('[data-part="trigger"]');
      this.popup = this.el.querySelector('[data-part="popup"]');
      this.open = () => {
  ...
  var liveSocket = new LiveSocket2("/live", Socket, {
    ...
    hooks: { ...Hooks2, ...imp_nbxw623t }
  });
  import_topbar.default.config({ barColors: { 0: "#8b5cf6" }, shadowColor: "rgba(0, 0, 0, .3)" });
