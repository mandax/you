...
# archives it with audit logs, uploads to Proton Drive via rclone,
...
#   - rclone   (https://rclone.org) with a remote named "proton"
# =============================================================================
...
" 2>/dev/null)
  ...
  echo "[$DATE]   - Configure: rclone config (then verify: rclone listremotes)"
