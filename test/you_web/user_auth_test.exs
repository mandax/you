defmodule YouWeb.UserAuthTest do
  use YouWeb.ConnCase

  alias You.Accounts
  alias You.Accounts.Scope
  alias YouWeb.UserAuth

  import You.AccountsFixtures

  @remember_me_cookie "_you_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, YouWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
